...
class ManageBuilder
{
     ...
     * @return string
     */
    public static function toBuildCloudListHtml($list)
    {
        $html = '';
        if(!empty($list))
        {
            foreach($list as $v){
                $html.=self::toBuildCloudItem($v);
            }
        }
     ...
     * @return string
     */
    public static function toBuildCloudItem($item)
    {
        $html = '';
        $info=json_encode($item);
        $id = $item['id'];
     ...
     * @return string
     */
    public static function toBuildMenuListHtml($list)
    {
        $html = '';
        if(!empty($list))
        {
            foreach($list as $v){
                $html.=self::toBuildMenuItem($v);
            }
        }
     ...
     * @return string
     */
    public static function toBuildMenuItem($item)
    {
        $html = '';
        $info=json_encode($item);
        $id = $item['id'];
