...
class HaloRedis {
    ...
    const WECHAT_ACTIVE_TAG = 'wechat_active';
    const USER_STATUS_TAG = 'user_status';
    const WECHAT_TOKEN_TAG = 'wechat_token';

    //初始化
    public function __construct($host,$port,$password,$timeout=0,$dbname="",$type=1)
    {
